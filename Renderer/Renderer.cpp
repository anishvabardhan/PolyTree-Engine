...
#elif DX12_RENDERER
	m_DX12Renderer->SetModelConstants(pipelineMode, modelMatrix, modelColor, modelCBO);
#endif
}
...
void Renderer::DrawMesh(int numOfMeshlets)
{
	UNUSED(numOfMeshlets);
#if DX11_RENDERER
#elif DX12_RENDERER
	return m_DX12Renderer->DrawMesh(numOfMeshlets);
#endif
}
//
